...
function App() {
    ...
    const handleTextChange = (e: React.ChangeEvent<HTMLInputElement>) => setQuery(e.target.value)
    const handleAdd = () => setIsAddOpen(true)

    const handleAddProduct = async (name: string, price: string, unitPrice: string) => {
